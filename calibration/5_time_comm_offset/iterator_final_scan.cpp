...
int dim;
int vec_len; 
double actual_c = 29.979248;
double c = 29.18853457; //starting speed of muon set here
int scans = 50; //Number of scans
...
int main(int argc, char *argv[]){
    ...
    for (int sc = 0; sc < scans;sc++){
        //Scaanning speed of muons
        c = 29.18853457 + (0.01613700877*sc);
        ...
        //make new directory for each scan
        fs::create_directory(data_dir+"/"+to_string(sc));
        ...
        for (int i = 0; i < filenames.size();i++){
            ...
            string pred_file = data_dir + "/"+to_string(sc)+"/pred_offsets" + to_string(i) +".txt";
